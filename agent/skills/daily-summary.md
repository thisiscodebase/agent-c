...
2. Produce a concise briefing with two sections:
   - **Today** — top priorities and active focus
   - **Suggested next** — one concrete next action

Keep it scannable. Match the user's language.

<!-- TODO(Phase 3/4): rework into a full activity digest once Drive/HubSpot/Slack
connectors land — new HubSpot deal stages, Drive activity in tracked folders,
Slack mentions of tracked accounts. Per docs/ARCHITECTURE.md, this is the
