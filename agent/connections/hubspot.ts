...
export default defineMcpClientConnection({
  ...
  description:
    "HubSpot CRM: search and read companies and contacts (emails, notes, forms, owners). Resolve COMPANY first (include database_record_id → Platform UUID and companies_house_no → Companies House); load contacts via company association — never blank-query. Skip deals unless asked.",
  auth: connect({
